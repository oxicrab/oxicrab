...
- **FallbackProvider is Vec-based**: `FallbackProvider::new(Vec<(Arc<dyn LLMProvider>, String)>)` for chains, `FallbackProvider::pair()` for the legacy two-provider case. Built from `modelRouting.fallbacks` or `localModel`.
