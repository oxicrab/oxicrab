...
- **25 built-in tools**: Filesystem, shell, web, HTTP, browser, image generation, Google Workspace, GitHub, scheduling, memory, media, and more
...
25 built-in tools with timeout protection, panic isolation, result caching, and truncation middleware.
