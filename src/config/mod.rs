...
pub use schema::{
    ...
    DiscordCommand, DiscordCommandOption, DiscordConfig, DmPolicy, ExecToolConfig,
    ExfiltrationGuardConfig, FusionStrategy, GatewayConfig, GitHubConfig, GoogleConfig,
    ImageGenConfig, McpConfig, McpTrust, MediaConfig, MemoryConfig, ModelRoutingConfig,
    ObsidianConfig, PromptGuardAction, PromptGuardConfig, ProviderConfig, ProvidersConfig,
    RouterConfig, RssConfig, SandboxConfig, SlackConfig, TaskRouting, TelegramConfig,
    ...
    infer_provider_from_model, normalize_provider, parse_model_ref,
};
