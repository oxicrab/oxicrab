...
pub use schema::{
    ...
    DiscordCommandOption, DiscordConfig, ExfiltrationGuardConfig, GitHubConfig, GoogleConfig,
    ImageGenConfig, McpConfig, MediaConfig, MemoryConfig, ModelCost, ObsidianConfig,
    PromptGuardConfig, SlackConfig, TelegramConfig, TodoistConfig, TranscriptionConfig,
